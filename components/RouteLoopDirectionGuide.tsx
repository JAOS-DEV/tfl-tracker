...
export function RouteLoopDirectionGuide({
  ...
  if (orientation === "portrait") {
    return (
      <div className="grid min-w-0 grid-cols-2 gap-2 px-3 sm:px-0">
        <div className="min-w-0 rounded-xl border border-sky-200 bg-sky-50 px-3 py-3 dark:border-sky-900 dark:bg-sky-950/40">
          <p className="text-xs font-bold uppercase tracking-wide text-sky-700 dark:text-sky-300">
            Outbound ↓
          </p>
          <p className="mt-1 truncate text-sm font-semibold leading-snug text-zinc-900 dark:text-zinc-100">
            {outbound.from}
          </p>
        ...
        <div className="min-w-0 rounded-xl border border-violet-200 bg-violet-50 px-3 py-3 dark:border-violet-900 dark:bg-violet-950/40">
